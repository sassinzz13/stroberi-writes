...
(()=>{
    const e = new Error("Cannot find module './AddPost.module.css'");
...
const EditPost = ()=>{
    _s();
    const { year, month, day, slug } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"])(); // get post identifier
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const res = await fetch("http://127.0.0.1:8000/api/blog/posts/".concat(year, "/").concat(month, "/").concat(day, "/").concat(slug, "/edit/"), {
                method: "PUT",
                headers: {
            ...
            router.push("/posts/".concat(year, "/").concat(month, "/").concat(day, "/").concat(slug)); // redirect to post view
        } catch (err) {
...
_s(EditPost, "+i6GateOlFf0Ahs5PZcUSWMLmzs=", false, function() {
    return [
...
//# sourceMappingURL=src_components_6e821122._.js.map